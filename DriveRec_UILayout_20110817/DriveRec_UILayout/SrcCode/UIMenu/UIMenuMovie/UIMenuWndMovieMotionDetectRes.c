...
#ifndef UIMENUWNDMOVIEMOTIONDETECTRES_H
#define UIMENUWNDMOVIEMOTIONDETECTRES_H
...
CREATE_MENU_ITEM_DATA(STRID_OFF32,STRID_OFF,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndMovieMotionDet_Menu)
...
DECLARE_EVENT(UIMenuWndMovieMotionDet_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieMotionDet_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieMotionDet_Menu,0,1,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieMotionDet_Menu,UIMenuWndMovieMotionDet_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieMotionDet_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieMotionDet_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieMotionDet_Panel)
CREATE_CTRL(UIMenuWndMovieMotionDet_Panel,UIMenuWndMovieMotionDet_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieMotionDet)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieMotionDet)
DECLARE_CTRL_LIST(UIMenuWndMovieMotionDet)
CREATE_CTRL(UIMenuWndMovieMotionDet,UIMenuWndMovieMotionDet,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
